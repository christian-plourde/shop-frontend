 ...
 * @props - { object } -  config
 */
class Form_demo extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      mailSent: false,
                ...
                return (
                  <React.Fragment key={field.id}>
                    {field.type !== "textarea" ? (
                      ...
                      <React.Fragment>
                        <label>{field.label}</label>
                        <textarea className={field.shortName} placeholder={field.placeholder} onChange={e => this.handleChange(e, field.fieldName)} value={field.name} />
                      </React.Fragment>
                    )}
                  </React.Fragment>
                );
...
Form_demo.propTypes = {
  email_manager: PropTypes.object.isRequired
};